            ...
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    ...
                    <div class="ml-md-auto py-2 py-md-0">
                        <a href="<?=routeTo(isset($_GET['role']) ? 'users/'.$_GET['role'] : 'users/index')?>" class="btn btn-warning btn-round">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <?= Form::input('options-obj:ranting,id,nama', 'users[ranting_id]', ['class'=>"form-control","placeholder"=>'Ranting',"value"=>$old['ranting_id']??$data->ranting_id]) ?>
                                </div>
                                <div class="form-group">
